...
Currently, we are implementing Design Tokens into our components. Implementing Design Tokens implies migration from styled-component's ThemeProvider to CSS variables. Because of this, we temporarily are supporting two themes system .
